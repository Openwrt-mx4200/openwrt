...
define Device/linksys_mx4200v1
	...
	DEVICE_PACKAGES := kmod-leds-pca963x ipq-wifi-linksys_mx4200 kmod-ath10k-ct-smallbuffers kmod-usb3 kmod-usb-storage kmod-usb-storage-uas kmod-fs-ext4
endef
...
define Device/linksys_mx4200v2
	...
	IMAGES += factory.bin
	IMAGE/factory.bin  := append-kernel | pad-to $$$$(KERNEL_SIZE) | append-ubi | linksys-image type=MX4200
	DEVICE_PACKAGES := kmod-leds-pca963x ipq-wifi-linksys_mx4200 kmod-usb3 kmod-usb-storage kmod-usb-storage-uas kmod-fs-ext4
endef
